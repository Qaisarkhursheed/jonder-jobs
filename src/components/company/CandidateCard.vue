<template>
  <v-card flat class="candidate-card rounded-lg" :class="`${type}-border`">
    <div
    ...
    <v-card-actions
      class="note-actions d-flex flex-column align-end justify-end pa-0 pr-4 mb-4 text-color-primary-blue-dark"
    >
